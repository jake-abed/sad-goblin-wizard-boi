...
@export var spawners_one: Array[EnemySpawner]
@export var spawners_two: Array[EnemySpawner]
@export var spawners_three: Array[EnemySpawner]
@export var spawners_four: Array[EnemySpawner]
...
@onready var spawners := [spawners_one, spawners_two, spawners_three, spawners_four]

func _ready() -> void:
	
	for spawner_group in spawners:
...
func _on_spawn_timer_timeout() -> void:
	for spawner_group in spawners:
		print(spawner_group)
		var spawn: EnemySpawner = spawner_group.pick_random()
		spawn.spawn_enemy()
